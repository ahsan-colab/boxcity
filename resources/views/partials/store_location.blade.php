                ...
                <div class="location-details">
                    ...
                    <div class="location-info active" id="van-nuys">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/ihsiEu9ve6LKCngN6',
                        ])
                    </div>
                    ...
                    <div class="location-info" id="north-hollywood">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/JGLfcGa3ojPLazjXA'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="west-la">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/kUWn2fkvgFnxxipe7'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="valencia">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/XDFyRigc4BTk4wvk9'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="pasadena">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/YnwxGJrsCL3GnMJH7'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="marina-del-rey">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/CKRnwYkjz24tfFps8'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="canoga-park">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/hycpoVejFCGNJ6jK8'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="glendale">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/mLLhwhfkY9tRmx8t9'
                        ])
                    </div>
                    ...
                    <div class="location-info" id="azusa">
                        @include('partials.location_template', [
                            ...
                            'url' => 'https://maps.app.goo.gl/ZmjLyfiTEoB1EHEe7'
                        ])
                    </div>
